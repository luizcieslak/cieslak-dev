...
seo:
  title: Entendendo as limitações do navegador Safari
  description: O Safari é o novo Internet Explorer — cheio de problemas visuais e comportamentos diferentes dos outros navegadores. Uma referência de como resolver cada um.
  image:
    src: '/ie-apple.png'
...
<script async src="//jsfiddle.net/luizcieslak/gje2t57r/36/embed/result,css/dark/"></script>
