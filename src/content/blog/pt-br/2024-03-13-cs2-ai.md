...
Acertou quem ganhou o campeonato? **No** (NaVi ganhou, Spirit foi a predição)
...
Acertou quem ganhou o campeonato? **No** (NaVi ganhou, Vitality foi a predição)

## Análise dos resultados

Todas as execuções acima foram feitas antes do campeonato começar.

Para todas as partidas, existe um elemento importante que não foi analisado pela LLM: a **escolha do mapa**.
...
Já na disputa de cada partida, a LLM não obteve um resultado bom. Um grande fator para isso ter acontecido foi o fato de que cada rodada do campeonato depende diretamente dos resultados das partidas anteriores. Assim, quanto mais a LLM fazia previsões erradas, menos partidas em que ela preveu de fato aconteceram.
