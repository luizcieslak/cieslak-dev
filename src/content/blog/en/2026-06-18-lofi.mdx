...
The inspiration is the "Ambilight" effect in Philips TVs where they put a strip of LED lights behind the TV that changes from the colors appearing in the screen.
...
when it landed was a success as ppl could listen to music without needing to carry anything rather a smaller device like iPod or this stick below.
