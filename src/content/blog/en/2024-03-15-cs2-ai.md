---
title: How to predict CS2 games using a LLM
...
- The latest articles mentioning the team.
- Overview Stats: KDA Ratio and Win rate.
- Event history.
...
Here are some interesting responses it outputted.
...
The LLM understands that Lynn Vision has won a lot of tournaments but they are from their region and that doesn't translate to a good international Major championship performance.
