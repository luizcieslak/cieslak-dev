...
excerpt: An LLM was provided with articles and statistics of CS2 teams with the task to predict who is going to be the winner of the first CS2 Major.
...
I have used OpenAI's GPT4 to predict all the games in CS2 PGL Major Championship. For each round I provided the matchups, articles and stats and then asked which team would win that match.
...
Finally, in both runs, **Spirit** is predicted to be the champion against FaZe.
