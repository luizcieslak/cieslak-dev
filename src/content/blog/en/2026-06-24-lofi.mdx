...
seo:
  title: Building a LoFi Radio Station from Scratch
  description: After listening to LoFi for years, I built my own radio station — a streaming server, a web player, and everything I learned wiring the two together.
  image:
...
* [shelf](https://github.com/luizcieslak/shelf): Playlist management and replication in music apps like Spotify and YouTube Music.
...
<Checklist
	items={[
		{ label: 'First DMCA Takedown Notice?' },
		{
			...
			note: '<strong>Done:</strong> upload endpoint re-encodes the files. Commit <a href="https://github.com/luizcieslak/lofi-radio/commit/810bc0c22ccffd04eaf79a7ea180d33bb8b7b39a">here</a>.',
		},
		{ label: 'Normalize tracks volume',
			done: true,
			note: '<strong>Done:</strong> upload endpoint also apply a volume re-encoding if necessary. Stream feels way nicer. Commit <a href="https://github.com/luizcieslak/lofi-radio/commit/3dde231020efec11bc6cee46f5e4c4f751092261">here</a>.',
		},
