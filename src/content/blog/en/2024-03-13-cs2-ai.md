...
Later, I rerun the analysis this time using a better mechanism to get recent news and articles for each team:
...
In both analysis, the playoff semi-finals included these 4 teams:
...
Finally, **Spirit** is predicted to be the champion against FaZe in both runs.
...
GamerLegion will replace 9 Pandas in the championship. This is a re-analysis of everything considering it.

| Classification          | Challenger Stage | Legends Stage |
| ----------------------- | ---------------- | ------------- |
| 1st (3 wins - 0 losses) | ENCE             | Spirit        |
| 2nd (3 wins - 0 losses) | Cloud9           | Vitality      |
| 3rd (3 wins - 1 losses) | Eternal Fire     | MOUZ          |
| 4th (3 wins - 1 losses) | SAW              | FaZe          |
| 5th (3 wins - 2 losses) | FURIA            | NAVI          |
| 6th (3 wins - 2 losses) | Apeks            | Cloud9        |
| 7th (3 wins - 2 losses) | Heroic           | G2            |
| 8th (3 wins - 2 losses) | TheMongolZ       | ENCE          |

The same playoffs with those teams will happens but this time **Vitality** is predicted to be the champion against Spirit. Here are the full [results](https://github.com/luizcieslak/pick-ems/blob/main/RESULTS3.md)
...
I'll update this post after the championship ends to evalute the precision of these predicts.
